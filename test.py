...
def stage0_extract_pose_and_mask(img_path, pose_getter, padding=20):
    ...
    提取人物骨架图 + 人物区域 mask
    返回：
        - pose_image: OpenPose 骨架图 (PIL RGB)
...
def stage1_base_inpaint(
    ...
    person_mask.save("./tmp/stage1_person_mask_debug.png")
    person_mask_canvas.save("./tmp/stage1_person_mask_canvas_debug.png")
...
def main():
    ...
    pipe_canny = load_controlnet_inpaint_pipe(base_model, ctl_model_canny, vae_model)
